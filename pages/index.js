...
export default function Home() {
  return (
    <div className="bg-[#fff7f2] min-h-screen text-black font-sans">
      <div className="max-w-5xl mx-auto px-6 py-12">

        {/* Tittel og introduksjon */}
        <div className="text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-2">Stort hus i ypperlig beliggenhet</h1>
          <h2 className="text-xl md:text-2xl font-medium text-gray-700 mb-4">Bright and modern house in Sandnes</h2>
